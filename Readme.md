...
|:---------|:--------------------|:--------------|:------------|
| 6.1.108  | armv7-fpga          | 1             | [6.1.108-armv7-fpga-1](https://github.com/ikwzm/FPGA-SoC-Linux-Kernel-6.1/tree/6.1.108-armv7-fpga-1) |
...
```console
shell$ export RELEASE_TAG=6.1.108-armv7-fpga-1
